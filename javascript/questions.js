    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          "Computer Style Solutions",
          "Colorful Style Specification",
        ],
        correctAnswer: 0,
      },
      {
      ...
      },
      {
        ...
        options: [
          "Client-side scripting runs in the user's browser, while server-side scripting runs on the server.",
          "Client-side scripting is used for database management, while server-side scripting is used for user authentication.",
          "Client-side scripting is written in HTML, while server-side scripting is written in JavaScript.",
          "Client-side scripting is faster than server-side scripting.",
        ],
        correctAnswer: 0,
      },
      {
